package greedyAlgorithms.Kruskal;
 ...
 *
 * Kruskal's Algorithm is also a greedy algorithm that finds a minimum spanning tree in a graph. 
...
class Graph {
    ...
    /*
     * The main function to construct MST using Kruskal's algorithm Minimum Spanning
     * Tree
     */
    void KruskalMST() {
